...
<div class="container">
    <div class="card">
        ...
        <ul>
            ...
            @endforeach
        </ul> @endif <form action="{{route('people.store')}}" method="POST" novalidate>
        @csrf
            ...
            <label for="last_name">Last Name</label>
                        <input class="form-control String"  type="text"  name="last_name" id="last_name" value="{{old('last_name')}}"             maxlength="255"
                                    required="required"
                        >
            ...
            <label for="number">Number</label>
                        <input class="form-control String"  type="text"  name="number" id="number" value="{{old('number')}}"             maxlength="255"
                                    >
